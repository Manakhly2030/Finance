...
def execute(filters=None):
	...
	for inv in invoice_list:
		...
		row = [inv.name, inv.posting_date, inv.customer, inv.customer_name, inv.invoice_type, inv.customer_vat_tin,
...
def get_columns(invoice_list):
	...
	columns = [
		...
		_("Invoice Type") + "::120", _("Tin No") + "::120", 	
...
def get_invoices(filters):
	...
	return frappe.db.sql("""select name, posting_date, debit_to, project, customer, customer_name, invoice_type, customer_vat_tin, remarks, 
